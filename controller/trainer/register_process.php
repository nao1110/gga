...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    redirect('/gs_code/gga/page/trainer/register.php');
}
...
try {
    ...
    // トレーナー登録
    $stmt = $db->prepare("
        INSERT INTO trainers (name, email, password, is_active, created_at, updated_at)
        VALUES (?, ?, ?, 1, NOW(), NOW())
    ");
    ...
    error_log('Register Error (Trainer): ' . $e->getMessage());
